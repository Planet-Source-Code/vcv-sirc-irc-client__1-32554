...
Public strChanModes As String
Public strSetChanModes As String
Public strKey As String
Public strLimit As String
Public refWindow As CHANNEL

Public Sub LoadTopics()
    Dim i As Integer
    For i = 1 To topicCount
        lstTopicHistory.AddItem refWindow.GetTopic(topicCount - i + 1)
    Next i
    
    PutText_Reset rtbTopic, refWindow.GetCurTopic
End Sub

Public Sub SetInfo()
    AddModeTypes
    txtLimit.Text = strLimit
    txtKey.Text = strKey
End Sub
